...
addMarker: function (pan,lat, lng, options, bindHtml)
	...
	if(pan){
		...
		jQuery('.newLocation').css({"background-color":"white", 
				"border-style":"none",
				"border-color":"white",
				"border-width":"3px",
				"border-radius":"15px"});
		jQuery('#'+options.form.id).addClass('myLocationSelected');
		jQuery('#'+options.form.id).css({"background-color":"#B9D5B9", 
				"border-style":"solid",
				"border-color":"green",
				"border-width":"3px",
				"border-radius":"15px"});
...
function clickedDelete(count){
	if (jQuery('#geochron-delete'+count).is(':checked')){
		...
		jQuery('#hiddenDelete'+count).parent().find(':text').css({"background-color":"#c8c8c8", 
				"font-style":"italic",
				"border-style":"solid",
				"border-color":"#c8c8c8",
				"border-width":"3px",
		...
		jQuery('#hiddenDelete'+count).parent().find(':text').css({"background-color":"white",
				"font-style":"normal",
				"border-style":"none",
				"border-color":"white",
				"border-width":"3px",
